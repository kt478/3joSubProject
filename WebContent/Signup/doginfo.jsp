			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">강아지 정보추가</h2>
						<form action="${pageContext.request.contextPath}/dogregist.dog"
							...
							<div class="form-group">
								<label for="name"><i class="zmdi zmdi-pin-account"></i></label>
								<input type="text" name="dog_name" id="dog_name"
							...
							<div class="form-group" style="border-bottom: 1px solid gray;">
								<label for="feature"><i class="zmdi zmdi-tag-more"></i></label>
							...
							<div class="form-group">
								<label for="profile"><i class="zmdi zmdi-image-o"></i></label> <input
